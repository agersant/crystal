...
MapCollisionChainData.merge = function(self, otherChain)
	...
	for iOld, oldX1, oldY1, oldX2, oldY2 in self:segments() do
		for iNew, newX1, newY1, newX2, newY2 in otherChain:segments() do
			...
			local allFourPointsAligned =
							MathUtils.almostZero(MathUtils.crossProduct(oldX, oldY, newX1 - oldX1, newY1 - oldY1)) and
											MathUtils.almostZero(MathUtils.crossProduct(oldX, oldY, newX2 - oldX1, newY2 - oldY1));
			...
			if allFourPointsAligned then
				...
				local segmentsMatch = (MathUtils.almostZero(t1) and MathUtils.almostEqual(t2, 1)) or
                      								(MathUtils.almostEqual(t1, 1) and MathUtils.almostZero(t2));
