local CollisionMeshBuilder = require(
                                 "engine/resources/map/collision/CollisionMeshBuilder");
...
tests[#tests].body = function()
    ...
    builder:addPolygon(2, 1, {
        {x = 20, y = 10}, {x = 30, y = 10}, {x = 30, y = 20}, {x = 20, y = 20}
    });
    builder:addPolygon(0, 0, {
