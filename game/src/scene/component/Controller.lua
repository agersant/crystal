...
Controller.getEntity = function(self) return self._entity; end

Controller.isIdle = function(self) return not self._actionThread or self._actionThread:isDead(); end
...
Controller.stopAction = function(self) self._actionThread = nil; end

Controller.isTaskless = function(self) return not self._taskThread or self._taskThread:isDead(); end
...
Controller.stopTask = function(self) self._taskThread = nil; end
