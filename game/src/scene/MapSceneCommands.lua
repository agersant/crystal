...
local testMap = function() loadMap("dev"); end

CLI:addCommand("testMap", testMap);

local setDrawPhysicsOverlay = function(draw) gConf.drawPhysics = draw; end
...
local setDrawNavmeshOverlay = function(draw) gConf.drawNavmesh = draw; end
