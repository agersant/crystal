local testFiles = {
	"src/ai/movement/TestAlignGoal", "src/ai/movement/TestEntityGoal", "src/ai/movement/TestMovement",
 "src/ai/movement/TestPath", "src/ai/movement/TestPositionGoal", "src/ai/tactics/TestTargetSelector",
 "src/dev/cli/TestCLI", "src/input/TestInputDevice", "src/persistence/TestParty", "src/persistence/TestPartyMember",
