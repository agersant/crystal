...
local getVertex = function(self, i) return self._vertices[2 * i - 1], self._vertices[2 * i]; end
...
Path.init = function(self) self._vertices = {}; end
...
Path.vertices = function(self) return vertexIter, self, 0; end

Path.getNumVertices = function(self) return #self._vertices / 2; end
