...
local setZoom = function(zoom) GFXConfig:setZoom(zoom); end

local enableFullscreen = function() GFXConfig:setFullscreenEnabled(true); end

local disableFullscreen = function() GFXConfig:setFullscreenEnabled(false); end
