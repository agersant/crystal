...
Party.init = function(self) self._members = {}; end
...
Party.removeMember = function(self, member)
	...
	for i, partyMember in ipairs(self._members) do if partyMember == member then table.remove(self._members, i); end end
end

Party.getMembers = function(self) return TableUtils.shallowCopy(self._members); end

Party.toPOD = function(self)
	local pod = {};
	pod.members = {};
	for i, partyMember in ipairs(self._members) do table.insert(pod.members, partyMember:toPOD()); end
	return pod;
end
