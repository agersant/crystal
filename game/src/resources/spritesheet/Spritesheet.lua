...
Spritesheet.init = function(self, sheetData, image)
	...
	for k, animationData in pairs(sheetData.content.animations) do
		...
		if not self._defaultAnimationName then self._defaultAnimationName = k; end
	end
end

Spritesheet.getImage = function(self) return self._image; end

Spritesheet.getFrame = function(self, frameName) return self._frames[frameName]; end

Spritesheet.getAnimation = function(self, animationName) return self._animations[animationName]; end

Spritesheet.getDefaultAnimationName = function(self) return self._defaultAnimationName; end
