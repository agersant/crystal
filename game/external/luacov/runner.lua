...
runner.defaults = require("external.luacov.defaults")
...
-- end
-- @function debug_hook
runner.debug_hook = require(cluacov_ok and "cluacov.hook" or "external.luacov.hook").new(runner)
...
function runner.run_report(configuration)
	...
	local reporter = "external.luacov.reporter"
