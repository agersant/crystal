...
return {
	...
	content = {
		...
		frames = {
			attack_left_2 = { x = 0 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			attack_left_1 = { x = 1 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			attack_left_0 = { x = 2 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			walk_left_1 = 	{ x = 3 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			walk_left_0 = 	{ x = 4 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			idle_left = 	{ x = 5 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			
			attack_right_2 = 	{ x = 6 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			attack_right_1 = 	{ x = 7 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			attack_right_0 = 	{ x = 8 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			walk_right_1 = 		{ x = 9 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			walk_right_0 = 		{ x = 10 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			idle_right = 		{ x = 11 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			
			attack_up_2 = 	{ x = 12 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			attack_up_1 =	{ x = 13 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			attack_up_0 = 	{ x = 14 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			walk_up_1 = 	{ x = 15 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			walk_up_0 = 	{ x = 16 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			idle_up = 		{ x = 17 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			
			attack_down_2 = { x = 18 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			attack_down_1 =	{ x = 19 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			attack_down_0 = { x = 20 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			walk_down_1 = 	{ x = 21 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			walk_down_0 = 	{ x = 22 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
			idle_down = 	{ x = 23 * w, y = 0, w = w, h = w, ox = ox, oy = oy, },
