...
local pickFont = function(self, name)
	if name == "dev" then
		return crystal.conf.root .. "/assets/source_code_pro_medium.otf";
	end
	if name == "devBold" then
		return crystal.conf.root .. "/assets/source_code_pro_bold.otf";
	end
	if name == "devCondensed" then
		return crystal.conf.root .. "/assets/open_sans_condensed_bold.ttf";
	end
