...
| [signal](script_signal)         | Ends all threads that were scheduled to [end](thread_stop_on) upon a specific signal. Runs all threads that were [waiting](thread_wait_for) for it. |
